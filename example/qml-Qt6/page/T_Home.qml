...
FluScrollablePage{  //主页为可滑动的页面
    ...
    ListModel{
        ...
        ListElement{
            ...
            title:"InFiniteUI GitHub"
            desc:"Open-Source UI elements for any project,Create, share, and use beautiful custom elements made with CSS or Tailwind."
            url:"https://github.com/cherryi6081/InFiniteUI"
        }
    }
    ...
    FluText{
        text: "Recently updated functions"
        font: FluTextStyle.Title
        Layout.topMargin: 20
        Layout.leftMargin: 20
    }
